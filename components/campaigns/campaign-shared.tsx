...
> = {
  electric: {
    hero: "bg-[radial-gradient(circle_at_18%_18%,rgba(82,168,255,0.34),transparent_32%),radial-gradient(circle_at_88%_8%,rgba(0,71,255,0.22),transparent_28%),linear-gradient(135deg,#081427_0%,#102447_48%,#0F0F14_100%)]",
    glow: "bg-[#58A6FF]/28",
    plate: "border-white/10 bg-white/10",
  },
  studio: {
    hero: "bg-[radial-gradient(circle_at_20%_16%,rgba(116,197,255,0.30),transparent_30%),radial-gradient(circle_at_82%_16%,rgba(0,71,255,0.18),transparent_24%),linear-gradient(135deg,#0B172D_0%,#18284A_40%,#0F0F14_100%)]",
    glow: "bg-[#8DD0FF]/24",
    plate: "border-white/12 bg-white/12",
  },
  spotlight: {
    hero: "bg-[radial-gradient(circle_at_18%_14%,rgba(148,214,255,0.30),transparent_28%),radial-gradient(circle_at_82%_10%,rgba(0,71,255,0.24),transparent_32%),linear-gradient(140deg,#101826_0%,#162843_44%,#111827_100%)]",
    glow: "bg-[#0047FF]/24",
    plate: "border-white/10 bg-white/10",
  },
};
